...
gradeLetters = 'FDCBA'
scores = [59, 60, 61, 81, 68, 53, 91, 90, 82, 76, 71, 84]


def calcGrade(score):
    # TODO: use the bisect function to identify cutoff points for the letter grades
    i = bisect.bisect(breakpoints, score) # bisect_left to put 60 too as F
...
print(scores)
print(results)
print([{score, result} for score, result in zip(scores, results)])
